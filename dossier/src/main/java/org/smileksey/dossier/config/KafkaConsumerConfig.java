...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<? super String, ? super EmailMessageWithSES> consumerFactoryForSES() {
        ...
        return new DefaultKafkaConsumerFactory<>(
                props,
                new StringDeserializer(),
                new JsonDeserializer<>(EmailMessageWithSES.class, false));
    }
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, EmailMessageWithSES> kafkaListenerContainerFactoryForSES() {
        ConcurrentKafkaListenerContainerFactory<String, EmailMessageWithSES> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(consumerFactoryForSES());
        return factory;
    }
